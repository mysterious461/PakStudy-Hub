export const EDUCATION_HIERARCHY = {
  ...
  "Bachelors (BS)": {
    ...
    "Aeronautical Engineering": ["Aerodynamics", "Propulsion", "Flight Mechanics", "Aircraft Structures"],
    "Mechatronics Engineering": ["Robotics", "Control Systems", "Industrial Automation", "Machine Design"],
    "Business and Finance": ["Financial Accounting", "Corporate Finance", "Investment Analysis", "Marketing Management"],
    "Social Sciences": ["Sociology", "International Relations", "Political Science", "Anthropology"],
    "Psychology": ["Clinical Psychology", "Cognitive Psychology", "Developmental Psychology"],
    "Agri Sciences": ["Agronomy", "Plant Breeding", "Soil Science", "Plant Pathology"],
    "Food Sciences": ["Food Chemistry", "Food Microbiology", "Food Processing", "Food Quality Management"],
    "Biotechnology": ["Molecular Biology", "Genetic Engineering", "Bioinformatics", "Cell Biology"],
    "D-Pharm": ["Pharmaceutics", "Pharmacology", "Pharmaceutical Chemistry", "Pharmacy Practice"],
  ...
  "Masters (MS/MPhil)": {
    ...
    "Business and Finance": ["Advanced Financial Management", "Portfolio Management"]
  }
};
